...
class ImageClassificationService():
    def __init__(self, model_name, model_path):
        ...
        print("#############")
        self.model = make_model_by_name('resnext101_32x8d_wsl',54)
        # self.model = models.__dict__['resnext101_32x8d_wsl'](num_classes=54)
        # self.model = EfficientNet.from_name('efficientnet-b1',num_classes = 54)
        # self.model = EfficientNet.from_model('efficientnet-b7', num_classes=54)
        # self.model = EfficientNet.from_model('efficientnet-b7', num_classes=54)
        self.use_cuda = False
...
if __name__ == '__main__':
    img_dir = r'../train_data/train_data'
    label_dir = r'../train_data/train_data'
    # model_path = r'/home/honglong/WP/python/competition/huawei/xi_an/wp_01/m2/model_best.pth'
    model_path = '/home/gu/Young/AI/wp_01/model/epoch_95_97.0.pth'
